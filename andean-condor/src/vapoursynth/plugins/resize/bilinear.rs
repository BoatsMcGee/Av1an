...
impl VapourSynthPluginScript for Bilinear {
    #[inline]
    fn generate_script(&self, node_name: NodeVariableName) -> Result<(Option<Imports>, Vec<Line>)> {
        ...
        let line = {
            ...
            write!(&mut line, "core.resize.Bilinear(clip = {}", node_name)?;
